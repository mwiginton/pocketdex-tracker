...
const htmlPath =
  process.argv[2] ?? "C:/Users/miche/AppData/Local/Temp/b2a-limitless.html";
const outputPath =
  process.argv[3] ?? "supabase/seed-paldean-wonders-cards.sql";
...
const trainerTypeMap = {
  ...
  "pokÃƒÂ©mon tool": "pokemon_tool",
  "pokÃƒÆ’Ã‚Â©mon tool": "pokemon_tool",
  "pokÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©mon tool": "pokemon_tool",
  "pokÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©mon tool": "pokemon_tool",
  "pokÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©mon tool": "pokemon_tool",
};
...
function mapRarity(value) {
  ...
  const shinies = [...text].filter((character) => character === "\u2726").length;
  if (shinies > 0) return `shiny_${shinies}`;
...
-- Source checked 2026-06-25: https://pocket.limitlesstcg.com/cards/${setId}?display=list&show=all
--
-- Rarity convention:
