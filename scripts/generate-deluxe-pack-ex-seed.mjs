...
const htmlPath =
  process.argv[2] ?? "C:/Users/miche/AppData/Local/Temp/a4b-limitless.html";
const outputPath = process.argv[3] ?? "supabase/seed-deluxe-pack-ex-cards.sql";
...
-- Source checked 2026-06-24: https://pocket.limitlesstcg.com/cards/${setId}?display=list&show=all
--
-- Rarity convention:
