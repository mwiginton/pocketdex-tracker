...
const htmlPath =
  process.argv[2] ?? "C:/Users/miche/AppData/Local/Temp/b4a-limitless.html";
const outputPath =
  process.argv[3] ??
  "supabase/team-rockets-ambition/seed-team-rockets-ambition-cards.sql";
...
-- Source checked 2026-08-29: https://pocket.limitlesstcg.com/cards/${setId}?display=list&show=all
--
-- Rarity convention:
