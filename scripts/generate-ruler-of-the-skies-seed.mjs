...
const htmlPath =
  process.argv[2] ?? "C:/Users/miche/AppData/Local/Temp/b4-limitless.html";
const outputPath =
  process.argv[3] ?? "supabase/ruler-of-the-skies/seed-ruler-of-the-skies-cards.sql";
...
-- Source checked 2026-07-30: https://pocket.limitlesstcg.com/cards/${setId}?display=list&show=all
--
-- Rarity convention:
